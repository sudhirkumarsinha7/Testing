...
public class GSX {
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
	public void verifyBreakOutSessionConflict(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
		this.setUp("verify BreakOut Conflict");
		...
		SessionCatalog.breakOutSession();
		//SessionCatalog.ValidateSessionType();

		this.tearDown("verify BreakOut Conflict");
		}
	}
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
	public void verifyDevNetSessionConflict(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
		this.setUp("verify DevNet Conflict");
		...
		SessionCatalog.devNetSession();
		//SessionCatalog.ValidateSessionType();

		this.tearDown("verify DevNet Conflict");
		}
	}
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
