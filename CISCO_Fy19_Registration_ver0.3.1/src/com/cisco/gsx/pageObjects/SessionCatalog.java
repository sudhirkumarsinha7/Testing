...
public class SessionCatalog {
	...
	public static void breakOutSession(){
		...
		CommonUtil.explicitlyWait(2);
		CommonUtil.click(elementProperties.getProperty("cisco.gsx.session.AddtoMyinterest.button.error"));
		CommonUtil.explicitlyWait(3);
		breakOutError();
	...
	public static void breakOutError(){
		...
		{	
		   ...
		   System.out.println("Type"+checkboxes.get(i).getAttribute("name"));
				...
				if(checkboxes.get(i).getAttribute("name").equalsIgnoreCase("1820604147")) {
					...
					CommonUtil.isChecked(elementProperties.getProperty("Cisco.Sessiontype.DevNetSession"));
					CommonUtil.explicitlyWait(1);
					SessionCatalog.validateSessionTypes(elementProperties.getProperty("cisco.gsx.Sessiontype.DevNetSession"), "DevNet Session",
					...
					CommonUtil.explicitlyWait(1);
					SessionCatalog.validateSessionTypes(elementProperties.getProperty("cisco.gsx.Sessiontype.SuperSession"), "Super Session"
	...
	public static void SessionCategory() {
		...
		System.out.println("Category");
			...
			{	
				...
				CommonUtil.scroll(CommonUtil.findElement(elementProperties.getProperty("Cisco.SessionCategory.Security")));
				CommonUtil.explicitlyWait(1);
				...
				CommonUtil.scroll(CommonUtil.findElement(elementProperties.getProperty("Cisco.SessionCategory.SellerEnablement")));
				CommonUtil.explicitlyWait(1);
				...
				System.out.println("SellerEnablement");
				CommonUtil.scroll(CommonUtil.findElement(elementProperties.getProperty("Cisco.SessionCategory.SellingSoftWare")));
				CommonUtil.explicitlyWait(1);
	...
	public static void sessionPillar(){
		...
		System.out.println("Category");
			...
			System.out.println("Track"+checkboxes.size());
			filtersCount(checkboxes.size(),6,"Pillar");
			CommonUtil.explicitlyWait(1);
			...
			{	
				...
				if(checkboxes.get(i).getAttribute("name").equalsIgnoreCase("1631722066")) {
					...
					//CommonUtil.switchToFrame();
					CommonUtil.isAlertPresent();
					SessionCatalog.validatePillar(elementProperties.getProperty("Cisco.Pillar.text"), "Reinvent the Network");
					CommonUtil.click(elementProperties.getProperty("Cisco.Sessioncatalog.Sessiontype.Pillar"));
					CommonUtil.explicitlyWait(2);
					CommonUtil.isChecked(elementProperties.getProperty("Cisco.SessionCatalog.ReinventtheNetwork"));
					CommonUtil.explicitlyWait(1);
					...
					System.out.println("CIsco Captial");
					CommonUtil.isChecked(elementProperties.getProperty("Cisco.SessionCatalog.MeaningFullExperience"));
					System.out.println("Selected Cisco Capital checkbox");
					CommonUtil.waitForPageload();
					CommonUtil.ESCAPE();
					CommonUtil.explicitlyWait(2);
					...
					//CommonUtil.switchToFrame();
					CommonUtil.isAlertPresent();
					SessionCatalog.validatePillar(elementProperties.getProperty("Cisco.Pillar.text"), "Create Meaningful Experiences");
					CommonUtil.click(elementProperties.getProperty("Cisco.Sessioncatalog.Sessiontype.Pillar"));
					CommonUtil.explicitlyWait(2);
					CommonUtil.isChecked(elementProperties.getProperty("Cisco.SessionCatalog.MeaningFullExperience"));
					CommonUtil.explicitlyWait(1);
					...
					//CommonUtil.switchToFrame();
					CommonUtil.isAlertPresent();
					SessionCatalog.validatePillar(elementProperties.getProperty("Cisco.Pillar.text"), "Security is Foundational");
					CommonUtil.click(elementProperties.getProperty("Cisco.Sessioncatalog.Sessiontype.Pillar"));
					CommonUtil.explicitlyWait(2);
					CommonUtil.isChecked(elementProperties.getProperty("Cisco.SessionCatalog.SecurityFoundational"));
					CommonUtil.explicitlyWait(1);
