	...
	public static void openBrowser(String browserType) {
		...
		try {
			...
			if (browserType.equalsIgnoreCase("firefox")) {
				...
				try {
					System.setProperty("webdriver.ie.driver", "D:\\driver\\IEDriverServer_Win32_3.12.0\\IEDriverServer.exe");
		...
		try {
			if (driver != null) {
			   ...
			   //  ImageIO.write(fpScreenshot.getImage(),"PNG",new File("D:///FullPageScreenshot.png"));
			     Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(50)).takeScreenshot(driver);
